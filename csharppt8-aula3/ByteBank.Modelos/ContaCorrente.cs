...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente : IComparable
    {
        ...
        {
            // retornar negativo quando a instancia for antes do obj
            // retornar zero quando a instancia e obj forem equivalentes
            // retornar positivo quando a instancia for positiva


            var conta = obj as ContaCorrente; // fazendo a conversão do tipo object para o tipo conta corrente
