...
namespace CasaDoCodigo.Models
{
    ...
    public class Cadastro : BaseModel
    {
        ...
        [MinLength(5, ErrorMessage = "Nome deve ter no mínimo 5 caracteres")] //definindo o tamanho minimo para o nome, 5 caracteres
        [MaxLength(50, ErrorMessage = "Nome deve ter no máximo 50 caracteres")] //definindo o tamanho maximo para o nome, 50 caracteres
        ...
        {
            this.Bairro = novoCadastro.Bairro; //implementando as propriedades do cadastro
